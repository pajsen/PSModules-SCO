...
Function Get-EcSCOModuleDirectory {
	$Invocation = Get-Variable MyInvocation -Scope 1 -ValueOnly
	Split-Path -Parent $($Invocation.MyCommand.source)
}

Get-ChildItem (Get-EcSCOModuleDirectory) -Recurse -Verbose:$false | Where-Object -Verbose:$false { $_.Name -like "Func.*" } | ForEach-Object {
    try{. $_.FullName}
    catch{Write-Host -ForegroundColor DarkCyan $_.Exception.Message}} -Verbose:$false

Export-ModuleMember -Function Get-EcSCORunbookServer,Get-EcSCORunbook -Alias * -Cmdlet * -Verbose:$false


# SIG # Begin signature block
# MIIPSAYJKoZIhvcNAQcCoIIPOTCCDzUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUBq2Adf/EEbPQ6xG6ZxpND3GW
# tBWgggyvMIIGEDCCBPigAwIBAgITMAAAACpnbAZ3NwLCSQAAAAAAKjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUcj7A3ROjRApkg8IFJROU2MTl7ccwDQYJKoZI
# hvcNAQEBBQAEggEAcS0YLyTOH33+mNN7EB7Uqv1Pu7tVUKZ/RDnfzkL3FyP9fYv6
# NTKRV8bI7m+xsWMonskLewyW9nG1etNm++5zSgG0+dfUCsQBQEW0wi4bVB7xseCt
# fCpOr5tsfI/c7XeodWD93GH5A65+2QvNYjoDxRUWGPFreAV6ysZMsbW+S6eXusj/
# /1QLNydLxxK3x76C70DZO+laWOdmKjZVID273/rryHCR0lCKSYikk3O4HdBh45qR
# 0CSjXAddClBU0VHxeACBbUNGEjNH277av2VdJ2QiIICPPHt8LOCRYZC1O+Yj4xgA
# xNkZWBIcvfZU8hapuClIgpCDpvwhEEPEUkGbPQ==
